...
@section('title')
    <title>Postingan Kami - ServicIyan</title>
@endsection
        ...
        <div class="container">
            <div class="card mb-3">
                {{-- <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->kategory->name }}" class="card-img-top"
                    alt="..."> --}}
                <img src="{{ asset('storage/posts/' . $posts[0]->image) }}" class="card-img-top"
                    alt="{{ $posts[0]->name }}">
                ...
                @foreach ($posts->skip(1) as $post)
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            ...
                            <img src="{{ asset('storage/posts/' . $post->image) }}" class="card-img-top"
                                alt="{{ $post->name }}">
                            <div class="card-body">
